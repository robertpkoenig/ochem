...
import { ReactionEditor } from '../pages/editor/reactions/[reactionId]'



function createP5EditingContext(reactionEditor: ReactionEditor, reaction: Reaction) {
...
export default createP5EditingContext