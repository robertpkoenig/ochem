...
class CurlyArrowCreator {
  ...
  private completeArrowIfReleasedOverAtom() {
    const atomCurrentlyHovered = this.hoverDetector.atomCurrentlyHovered;

    if (
      atomCurrentlyHovered != null &&
  ...
  private completeArrowIfReleasedOverBond() {
    const bondCurrentlyHovered = this.hoverDetector.bondCurrentlyHovered;

    if (
      bondCurrentlyHovered != null &&
  ...
  private completeArrowIfReleasedOverIon() {
    const ionCurrentlyHovered = this.hoverDetector.ionCurrentlyHovered;
    if (
      ionCurrentlyHovered != null &&
