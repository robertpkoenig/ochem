      ...
      <div className="min-h-screen bg-gray-100">
          ...
          <div className="py-5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-3 ">
              ...
              <div className="flex flex-row justify-between">
                <ListOfSteps state={state} setState={setState} />
        ...
        <main className="-mt-32">
          <div className="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8 flex flex-row gap-5">
            <EditorLeftButtons state={state} setState={setState} />
            {/* p5 canvas */}
            <div
              id={CANVAS_PARENT_NAME}
              className="h-700 bg-white rounded-lg shadow flex-grow"
            />
          ...
          <div
            id="eraser-tip"
            style={{ display: "none" }}
            className="text-xs bg-gray-400 text-white rounded-sm shadow px-2 py-1 font-light absolute "
          >
            Delete
          </div>
        </main>
