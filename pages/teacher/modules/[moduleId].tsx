...
export default function ModulePage() {
  ...
  function createSection(name: string) {
    ...
    const moduleRecordDocLocation = doc(db, MODULES, module.uuid);
  ...
  const sectionListEmptyState = (
    <EmptyState text="This module has no sections" />
  );
  ...
  if (module && module.sections) {
    const orderedSectionObjects = Object.values(module.sections).sort(
      (a, b) => {
  ...
  return (
    <ScreenWithLoading loading={loading}>
      <ModuleEditorLayout module={module}>
