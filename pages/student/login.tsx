...
class Login extends React.Component<IProps> {
    ...
    constructor(props: IProps) {
        super(props)
        this.moduleName = this.props.router.query.moduleId as string
    }
    ...
    render() {
        return (
                ...
                <div className="mt-8 sm:mx-auto">
                    ...
                    <div className="bg-white shadow sm:rounded-lg flex flex-row ">
                        ...
                        <form className="space-y-6 p-10 sm:w-full sm:max-w-md" action="#" method="POST">
                        <div>
