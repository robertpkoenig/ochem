...
function Features() {
    return (
        <div id="features" className="relative bg-white p-24 lg:p-36 flex flex-col gap-24 lg:gap-24 overflow-hidden">
            ...
            {features.map(feature => {
                ...
                <div className="relative lg:mb-0">
                    ...
                    <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                        ...
                        <div className={classNames("px-4 max-w-xl mx-auto sm:px-6 lg:py-36 lg:max-w-none lg:mx-0 lg:px-0", oddIndex && "lg:col-start-2")}>
                            <div>
                                <div>
                        ...
                        <div className={classNames("mt-12 sm:mt-16 lg:mt-0", oddIndex && "lg:col-start-1")}>
                            <div className={classNames("lg:px-0 lg:m-0 lg:relative lg:h-full", oddIndex ? "lg:pr-4 lg:-ml-48 lg:pl-6 lg:-mr-16" : "lg:pl-4 lg:-mr-48 lg:pr-6 lg:-ml-16" )}>
                                <img
                                    className={classNames("mx-auto max-w-md md:w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:h-full lg:w-auto lg:max-w-none", oddIndex ? "lg:right-0 " : "lg:left-0")}
                                    src={feature.img}
