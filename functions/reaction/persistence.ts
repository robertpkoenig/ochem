...
import { MODULES, REACTIONS, REACTION_LISTINGS, SECTIONS, VISIBLE } from "../../persistence-model/FirebaseConstants"
...
function toggleVisibility(
    ...
    const reactionRefWithinSection =
        SECTIONS + "."+ reactionCopy.sectionId + "."+
        REACTION_LISTINGS + "." + reactionCopy.uuid + 
        "." + VISIBLE

    const sectionVisibilityUpdateObject: any = {}
    sectionVisibilityUpdateObject[reactionRefWithinSection] = reactionCopy.visible
